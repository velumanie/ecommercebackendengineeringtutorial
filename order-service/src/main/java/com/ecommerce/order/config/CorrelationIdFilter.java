...
/**
 * The gateway assigns a correlation id at the edge; this filter simply trusts it (or
 * mints one for requests that reach this service directly, e.g. in local dev) and makes
 * it available via MDC for logging and Feign propagation.
 */
@Component
@Order(1)
