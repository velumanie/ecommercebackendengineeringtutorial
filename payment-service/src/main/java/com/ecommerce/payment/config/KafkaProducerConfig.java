...
/**
 * Only {@link com.ecommerce.payment.event.OutboxPublisher} talks to Kafka directly now — the
 * outbox already stores each event pre-serialized to JSON (see PaymentEventProducer), so this
