    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtDecoder jwtDecoder,
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/payments/authorize").hasRole("CUSTOMER")
                        .requestMatchers(HttpMethod.POST, "/api/v1/payments/*/refund").hasAnyRole("MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/payments/**").hasAnyRole("CUSTOMER", "MANAGER", "ADMIN")
